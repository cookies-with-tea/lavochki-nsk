...
import {menuItems} from "@/app/components/Layouts/DefaultLayout/DefaultLayoutMenu/DefaultLayoutMenu.constants";
...
const DefaultLayoutMenu: FC<IProps> = ({anchorEl, open, onClose, handleLogout}) => {
    return (
            <Menu
                id="profile-menu"
                anchorEl={anchorEl}
