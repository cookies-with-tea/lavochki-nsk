...
const getPointData = (bench: Partial<IBench>) => {
    const balloonBody = bench.images &&
...
const HomeMap: FC<{ benches?: IBench[] }> = ({benches}) => {
    return (
        <div className="mb-52">
            ...
            <YMaps>
                ...
                >
                    ...
                    >
                        {
                            benches && benches.map(({lat, lng, id, images}: IBench, idx: number) => {
                                return (
                                    <Placemark
                                        key={idx}
                                        geometry={[lat, lng]}
